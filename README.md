...
* To obtain the guides.csv file, click Content (main menu) > Guides. On this page, click the Export all Records button and select CSV.
* [Jump to instructions on exporting the A-Z Databases CSV file](#Importing-from-a-LibGuides-AZ-Export)
---
...
## Importing from a LibGuides AZ Export
