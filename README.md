...
YAML files are very easy to edit, so librarians should be able to customize their own databases.yaml files following the template generated by the script.
